...
export default class userSignUp extends Component {
    ...
    addNewPackage = (event) => {
        ...
        axios({
            ...
            method: 'POST',
            url: 'http://localhost:3800/api/users/create',
            data: userBody,
    ...
    render() {
        return (
            <div style={{ backgroundImage: 'url("https://wallpaperaccess.com/full/1431600.jpg")', backgroundSize: "cover", position: "relative", height: "560px" }}>
                <div className="card" style={{ opacity: 0.9, borderRadius: 30, position: 'absolute', marginTop: 25, height: 500, width: 500, justifyContent: 'center', marginLeft: 500 }} >
                    <div className="card-body">
                        <form style={{ marginLeft: 50, marginTop: 20 }}>
                            ...
                            <button onClick={this.addNewPackage} className="btn btn-primary" type="submit">Sign up</button>
                        </form>
                    </div>
                </div>
            </div>
